...
async function sendUserMessage() {
    ...
    const systemPrompt = `
        ...
        2. PEDAGOGIE, INSTANT GENERATION ȘI MODURI SPECIALE:
           - GENERARE DIRECTĂ: Dacă elevul cere explicit eseul complet, comentariul întreg sau rezolvarea completă (ex: "dă-mi comentariul complet", "vreau eseul gata făcut", "scrie-mi eseul"), oferă-i OBLIGATORIU eseul sau rezolvarea completă, de înaltă calitate și gata făcută direct, fără a-l refuza sau amâna!
           - MOD SOCRATIC: În rest (dacă vrea să repete, să exerseze, să fie testat sau pune întrebări punctuale), aplică Metoda Socratică: nu îi da rezolvarea direct, ci ajută-l ghidat să o descopere prin întrebări inteligente.
